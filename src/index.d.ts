declare module 'remx' {
  ...
  export function useConnect<T extends {}>(remxFunc: () => T, dependencies?: unknown[]): T;
  export function useConnect<T extends {}, A extends any[]>(remxFunc: (...a: A) => T, dependencies?: A): T;
}
